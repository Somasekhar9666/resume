...
\begin{itemize}[leftmargin=0.15in, label={}]
  ...
  \item \textbf{Network Automation:} pyATS, pytest, REST/JSON API automation, CLI device automation, polling \& retry patterns, fixture design, YAML testbeds
  ...
  \item \textbf{Languages:} Python (primary), Shell / Bash Scripting, SQL
  \item \textbf{CI/CD:} Jenkins, pipeline-as-code, parallel execution, release gating, artifact management, structured logging
